  ...
  return (
    <Container>
      <Stack
        ...
        alignItems={"center"}
      >
        <SectionTitle title={"Holidays"} description={"Manage your holidays"} />
      ...
      {/* Edit holiday */}
      <EditHolidayModal open={open} setOpen={setOpen} id={productId} />

      {/* Add holiday */}
      <CreateHolidayModal open={createModal} setOpen={setCreateModal} />
    </Container>
  );
};
